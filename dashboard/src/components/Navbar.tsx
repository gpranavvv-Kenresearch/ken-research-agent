    ...
    <div className="bg-amber-950/40 border-b border-amber-800/40">
      <div className="max-w-screen-2xl mx-auto px-6 py-2 flex items-center gap-3 text-sm">
        ...
        <span className="text-amber-200 flex-1">
          New platforms are live: <span className="font-semibold">Coda</span> (blog) and <span className="font-semibold">Tumblr</span> (social posting). Head to <span className="font-semibold">Logins</span> and log in to start posting to them.
        </span>
